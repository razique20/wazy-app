  ...
  void initState() {
    ...
    _allFaqs = [
      FaqItem(
        ...
        question: 'How does Wazy track document expiries?',
        answer:
            'Wazy monitors all your added documents (Emirates ID, Passports, Visas, Trade Licences, Mulkiya, Insurance) and notifies you at key lead times (90, 60, 30, 14, 7, and 1 day before expiration). You can also customize reminder lead times in Settings.',
      ),
      FaqItem(
        category: 'Documents',
      ...
      FaqItem(
        ...
        answer:
            'Uploaded document files (photos, scans, PDF receipts) are saved 100% locally on your device in the app\'s secure storage folder (/wazy/documents/). They remain strictly on your phone and are never uploaded to external cloud file servers.',
      ),
      FaqItem(
        category: 'Documents',
      ...
      FaqItem(
        ...
        answer:
            'When logging an expense (e.g., "Paid 450 AED for DEWA"), Wazy automatically identifies UAE merchants and categories (like Utilities, Transport, Food, Govt Fees) using fuzzy matching and a UAE keyword dictionary.',
      ),
      FaqItem(
        category: 'Money',
        ...
        answer:
            'Mark any expense or income as "Repeat Monthly/Yearly". Wazy auto-logs them when due and calculates a 90-Day Cash Flow forecast combining bank balance, upcoming recurring bills, and document renewal fees.',
      ),
      FaqItem(
        category: 'Money',
        ...
        answer:
            'Wazy automatically detects sudden price increases in recurring expenses (e.g., a utility bill jumping 35%+ higher than your average) and alerts you so you can review potential overcharges.',
      ),
      FaqItem(
        category: 'AI & Voice',
        ...
        answer:
            'Tap the Voice / Sparkle button on the Home or Money screen and speak or type naturally (e.g., "Spent 85 AED on Uber today"). Wazy extracts the amount, vendor, category, and date automatically.',
      ),
      FaqItem(
        category: 'AI & Voice',
        ...
        answer:
            'No! Wazy includes built-in smart templates out of the box. Adding your free Gemini API key in Settings is optional and enables deeper executive summaries generated by Google Gemini.',
      ),
      FaqItem(
        category: 'Account & Tiers',
        icon: Icons.wifi_off_rounded,
        question: 'Does Wazy work offline without internet?',
        answer:
            'Yes! Wazy uses local-first caching. All your data is saved locally on your device for fast offline access and automatically syncs with cloud database when reconnected.',
      ),
      FaqItem(
        category: 'Account & Tiers',
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Everything you need to know about Wazy',
                ...
                itemBuilder: (ctx, idx) {
                  ...
                  return ChoiceChip(
                    ...
                    labelStyle: TextStyle(
                      color: selected
                          ? (isDark ? const Color(0xFFD97706) : WazyColors.ink)
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: isDark
                    ? WazyColors.obsidian
                    : WazyColors.navyPrimary.withOpacity(0.04),
                border: Border(
                  top: BorderSide(
