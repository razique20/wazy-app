...
> **Never miss a document renewal or let bill spikes catch you off guard again.**  
> **Wazy** is an all-in-one personal & small-business document expiry tracking and financial intelligence platform built for mobile and web.

---

## 🌟 Key Features

### 📁 1. Document Expiry Radar
...
### 💸 2. Financial Intelligence & Cash Flow Management
- **Unified Ledger**: Track income and expense transactions (`finance_transactions`) tagged by collection and category.
- **Category Budgets**: Set monthly spending limits per category (`renewals`, `salaries`, `rent`, `utilities`, `suppliers`, `marketing`, `transport`, `software`, `sales`, `other`) with visual budget utilization indicators.
